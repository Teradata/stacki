...
class TestSetBootactionKernel:
	def test_set_bootaction_kernel_no_args(self, host):
	...
	def test_set_bootaction_kernel_multiple_args(self, host):
	...
	def test_set_bootaction_kernel_invalid_action(self, host):
	...
	def test_set_bootaction_kernel_no_type(self, host):
	...
	def test_set_bootaction_kernel_invalid_type(self, host):
	...
	def test_set_bootaction_kernel_no_kernel_parameter(self, host):
	...
	def test_set_bootaction_kernel_with_os(self, host):
	...
	def test_set_bootaction_kernel_os_is_null(self, host):
