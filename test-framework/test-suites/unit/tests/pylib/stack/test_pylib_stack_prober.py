...
# to probe 
PALLET_DATA = [
	['stacki', '05.03.00.00_20190905_5e7b1ce', 'sles12', 'x86_64', 'sles', 'NativePalletProbe', {'roll-stacki.xml': 'roll-stacki.xml'}],
	['tdc-infrastructure', '01.05.00.00', 'sles12sp3', 'x86_64', 'sles', 'NativePalletProbe', {'roll-tdc-infrastructure.xml': 'roll-tdc-infrastructure.xml'}],
	['CentOS', '7.4', 'redhat7', 'x86_64', 'redhat', 'TreeinfoProbe', {
		'CentOS-7-x86_64-Everything-1708.iso.treeinfo': '.treeinfo',
		'CentOS-7-x86_64-Everything-1708.iso.discinfo': '.discinfo',
	}],
	['CentOS', '7.7', 'redhat7', 'x86_64', 'redhat', 'TreeinfoProbe', {
		'CentOS-7-x86_64-DVD-1908.iso.treeinfo': '.treeinfo',
		'CentOS-7-x86_64-DVD-1908.iso.discinfo': '.discinfo',
	}],
	['RHEL', '7.6', 'redhat7', 'x86_64', 'redhat', 'ProductMDProbe', {'rhel-server-7.6-x86_64-dvd.iso.treeinfo': '.treeinfo'}],
	['RHEL-Supp', '7.6', 'redhat7', 'x86_64', 'redhat', 'ProductMDProbe', {'supp-server-7.6-rhel-7-x86_64-dvd.iso.treeinfo': '.treeinfo'}],
	...
	['SLES', '11.3', '1.138', 'x86_64', 'sles', 'SLES_11_12_Probe', {'SLES-11-SP3-DVD-x86_64-GM-DVD1.iso.content': 'content'}],
	['SLE-SDK', '11.3', '1.69', 'x86_64', 'sles', 'SLES_11_12_Probe', {'SLE-11-SP3-SDK-DVD-x86_64-GM-DVD1.iso.content': 'content'}],
	...
	['Ubuntu', '19.04', 'ubuntu19.04', 'x86_64', 'ubuntu', 'UbuntuProbe', {'ubuntu-19.04-desktop-amd64.iso.disk.info': '.disk/info'}],
	['Ubuntu-Server', '19.04', 'ubuntu19.04', 'x86_64', 'ubuntu', 'UbuntuProbe', {'ubuntu-19.04-live-server-amd64.iso.disk.info': '.disk/info'}],
]

class TestProbepal:

	@pytest.mark.parametrize('name, version, release, arch, distro_family, expected_probe, filemap', PALLET_DATA)
	def test_prober(self, test_file, name, version, release, arch, distro_family, expected_probe, filemap):
		...
		with tempfile.TemporaryDirectory() as paldir:
			...
			assert pal_map[paldir] == [pal.PalletInfo(name, version, release, arch, distro_family, paldir, expected_probe)]
