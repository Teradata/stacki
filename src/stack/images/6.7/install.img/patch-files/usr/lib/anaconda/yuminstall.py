        ...
        if what == rpm.RPMCALLBACK_INST_OPEN_FILE:
            ...
            while self.openfile is None:
                try:
                    ...
                    log.info("STACKI:getPackage:failed:retries (%d)" % retries)
...
class AnacondaYum(YumSorter):
    ...
    def mirrorFailureCB (self, obj, *args, **kwargs):
        # STACKI
        #
        # everytime we hit this method, increase the timeout 
        #
    ...
    def run(self, instLog, cb, intf, id):
        ...
        # STACKI
        self.ts.ts.setProbFilter(rpm.RPMPROB_FILTER_REPLACEOLDFILES |
