        ...
        while not networkEnabled:
            ...
            if just_setup:
                ...
                if 'build' in args:
                    ...
                    install_device = selectInstallNetDeviceDialog(
                        self.anaconda.id.network, nm_controlled_devices)

                log.info('STACKI: install_device %s' % install_device)

                # install_device = selectInstallNetDeviceDialog(self.anaconda.id.network, nm_controlled_devices)
                # STACKI
