...
class YumBase(depsolve.Depsolve):
    ...
    def _getSacks(self, archlist=None, thisrepo=None):
        ...
        # STACKI
        #
        # disable the 'anaconda-base' repo. i don't know where it comes from
        # but it causes an exception because there is no repomd.xml in it
        #
        repos = self.repos.listEnabled()
        for repo in repos:
            if repo.id.startswith('anaconda-base'):
                repo.disable()
        # STACKI
        ...
        self.repos.populateSack(which='enabled')
        # STACKI
