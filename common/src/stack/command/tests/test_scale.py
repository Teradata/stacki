...
def test_scale():
	...
	for size in [ 10, 20, 30, 40, 100, 1000 ]:
		...
		Call('report dhcpd')
		t = time.time() - t0
		print('report dhcpd'.ljust(32), '%.3fs' % t)
		

		# Set this to False to keep the last 1000 nodes in the
		# database. This is good for manual testing, of cource any
		# manual tests should be added to this list.

		if True or size != 1000:
			teardown_hosts()
