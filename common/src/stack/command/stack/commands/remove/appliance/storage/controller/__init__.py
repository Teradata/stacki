...
class Command(stack.commands.remove.command):
	"""
	Remove a storage controller configuration for an appliance.
	...
	<example cmd='remove appliance storage controller backend slot=1'>
	Remove the disk array configuration for slot 1 on the appliance 'backend'.
	</example>

	<example cmd='remove appliance storage controller backend slot=1,2,3,4'>
