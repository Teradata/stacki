...
class Command(stack.commands.set.firmware.command):
	...
	<example cmd="set firmware model imp m7800 m6036 make=Mellanox imp=mellanox_6xxx_7xxx">
	Sets the firmware models m7800 and m6036 for make Mellanox to run the mellanox_6xxx_7xxx implementation.
	</example>
	"""
